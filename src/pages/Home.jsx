      ...
      <main className="text-secondary font-abc">
        <section className="bg-[#222] h-screen w-full relative overflow-hidden">
          ...
          <div className="absolute top-1/2 -translate-y-1/2  left-1/2 z-10 -translate-x-1/2 text-center text-white">
            ...
            <div className="flex flex-col">
              ...
              <Link to="/listings" onClick={scrollTop} className="self-center text-white bg-primary py-3 px-8 rounded-lg  transition-all uppercase hover:scale-105 hover:bg-secondary font-abc-bold" >View Listing</Link>
            </div>
        ...
        <article className="px-8">
          <section className="flex flex-col items-center my-16 justify-center ">
            ...
            <div className="my-14 ">
              <Link to="/learns" onClick={scrollTop} className="text-white bg-primary py-3 px-8 rounded-lg  transition-all hover:scale-105 hover:bg-secondary"  >How it works</Link>
            </div>
